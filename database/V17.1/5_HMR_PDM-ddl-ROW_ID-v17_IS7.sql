...
--  - Addition of join between SUBMISSION_ROW and the 3 report staging tables with data conversion
-- =============================================
...
-- MODIFIED:  Drop rows incapable of data conversion and ensure ROW_ID is populated
PRINT (' ');
PRINT ('Deleting ROCKFALL_REPORT rows with no ROW_NUM: ');

DELETE FROM [dbo].[HMR_ROCKFALL_REPORT] WHERE [ROW_NUM] IS NULL;
GO
...
SELECT
    hrkflr.[ROCKFALL_REPORT_ID],hrkflr.[SUBMISSION_OBJECT_ID],hsr.[ROW_ID],hrkflr.[ROW_NUM],hrkflr.[VALIDATION_STATUS_ID],hrkflr.[MCRR_INCIDENT_NUMBER],hrkflr.[RECORD_TYPE],hrkflr.[SERVICE_AREA],hrkflr.[ESTIMATED_ROCKFALL_DATE],hrkflr.[ESTIMATED_ROCKFALL_TIME],hrkflr.[START_LATITUDE],hrkflr.[START_LONGITUDE],hrkflr.[END_LATITUDE],hrkflr.[END_LONGITUDE],hrkflr.[HIGHWAY_UNIQUE],hrkflr.[HIGHWAY_UNIQUE_NAME],hrkflr.[LANDMARK],hrkflr.[LANDMARK_NAME],hrkflr.[START_OFFSET],hrkflr.[END_OFFSET],hrkflr.[DIRECTION_FROM_LANDMARK],hrkflr.[LOCATION_DESCRIPTION],hrkflr.[DITCH_VOLUME],hrkflr.[TRAVELLED_LANES_VOLUME],hrkflr.[OTHER_TRAVELLED_LANES_VOLUME],hrkflr.[OTHER_DITCH_VOLUME],hrkflr.[HEAVY_PRECIP],hrkflr.[FREEZE_THAW],hrkflr.[DITCH_SNOW_ICE],hrkflr.[VEHICLE_DAMAGE],hrkflr.[COMMENTS],hrkflr.[REPORTER_NAME],hrkflr.[MC_PHONE_NUMBER],hrkflr.[REPORT_DATE],hrkflr.[GEOMETRY],hrkflr.[CONCURRENCY_CONTROL_NUMBER],hrkflr.[APP_CREATE_USERID],hrkflr.[APP_CREATE_TIMESTAMP],hrkflr.[APP_CREATE_USER_GUID],hrkflr.[APP_CREATE_USER_DIRECTORY],hrkflr.[APP_LAST_UPDATE_USERID],hrkflr.[APP_LAST_UPDATE_TIMESTAMP],hrkflr.[APP_LAST_UPDATE_USER_GUID],hrkflr.[APP_LAST_UPDATE_USER_DIRECTORY],hrkflr.[DB_AUDIT_CREATE_USERID],hrkflr.[DB_AUDIT_CREATE_TIMESTAMP],hrkflr.[DB_AUDIT_LAST_UPDATE_USERID],hrkflr.[DB_AUDIT_LAST_UPDATE_TIMESTAMP]
FROM [dbo].[HMR_ROCKFALL_REPORT] hrkflr INNER JOIN [dbo].[HMR_SUBMISSION_ROW] hsr ON hrkflr.[SUBMISSION_OBJECT_ID] = hsr.[SUBMISSION_OBJECT_ID] AND hrkflr.[ROW_NUM] = hsr.[ROW_NUM]
GO
...
-- MODIFIED:  Drop rows incapable of data conversion and ensure ROW_ID is populated
PRINT (' ');
PRINT ('Deleting ROCKFALL_REPORT_HIST rows with no ROW_NUM: ');

DELETE FROM [dbo].[HMR_ROCKFALL_REPORT_HIST] WHERE [ROW_NUM] IS NULL;
GO
...
SELECT
    hrkflr.[ROCKFALL_REPORT_HIST_ID],hrkflr.[EFFECTIVE_DATE_HIST],hrkflr.[END_DATE_HIST],hrkflr.[ROCKFALL_REPORT_ID],hrkflr.[SUBMISSION_OBJECT_ID],hsr.[ROW_ID],hrkflr.[ROW_NUM],hrkflr.[VALIDATION_STATUS_ID],hrkflr.[MCRR_INCIDENT_NUMBER],hrkflr.[RECORD_TYPE],hrkflr.[SERVICE_AREA],hrkflr.[ESTIMATED_ROCKFALL_DATE],hrkflr.[ESTIMATED_ROCKFALL_TIME],hrkflr.[START_LATITUDE],hrkflr.[START_LONGITUDE],hrkflr.[END_LATITUDE],hrkflr.[END_LONGITUDE],hrkflr.[HIGHWAY_UNIQUE],hrkflr.[HIGHWAY_UNIQUE_NAME],hrkflr.[LANDMARK],hrkflr.[LANDMARK_NAME],hrkflr.[START_OFFSET],hrkflr.[END_OFFSET],hrkflr.[DIRECTION_FROM_LANDMARK],hrkflr.[LOCATION_DESCRIPTION],hrkflr.[DITCH_VOLUME],hrkflr.[TRAVELLED_LANES_VOLUME],hrkflr.[OTHER_TRAVELLED_LANES_VOLUME],hrkflr.[OTHER_DITCH_VOLUME],hrkflr.[HEAVY_PRECIP],hrkflr.[FREEZE_THAW],hrkflr.[DITCH_SNOW_ICE],hrkflr.[VEHICLE_DAMAGE],hrkflr.[COMMENTS],hrkflr.[REPORTER_NAME],hrkflr.[MC_PHONE_NUMBER],hrkflr.[REPORT_DATE],hrkflr.[GEOMETRY],hrkflr.[CONCURRENCY_CONTROL_NUMBER],hrkflr.[APP_CREATE_USERID],hrkflr.[APP_CREATE_TIMESTAMP],hrkflr.[APP_CREATE_USER_GUID],hrkflr.[APP_CREATE_USER_DIRECTORY],hrkflr.[APP_LAST_UPDATE_USERID],hrkflr.[APP_LAST_UPDATE_TIMESTAMP],hrkflr.[APP_LAST_UPDATE_USER_GUID],hrkflr.[APP_LAST_UPDATE_USER_DIRECTORY],hrkflr.[DB_AUDIT_CREATE_USERID],hrkflr.[DB_AUDIT_CREATE_TIMESTAMP],hrkflr.[DB_AUDIT_LAST_UPDATE_USERID],hrkflr.[DB_AUDIT_LAST_UPDATE_TIMESTAMP]
FROM [dbo].[HMR_ROCKFALL_REPORT_HIST] hrkflr INNER JOIN [dbo].[HMR_SUBMISSION_ROW] hsr ON hrkflr.[SUBMISSION_OBJECT_ID] = hsr.[SUBMISSION_OBJECT_ID] AND hrkflr.[ROW_NUM] = hsr.[ROW_NUM]
GO
...
INSERT INTO [dbo].[HMR_SUBMISSION_ROW_TMP]
    ([ROW_ID],[SUBMISSION_OBJECT_ID],[ROW_STATUS_ID],[ROW_NUM],[RECORD_NUMBER],[ROW_VALUE],[ROW_HASH],[IS_RESUBMITTED],[ERROR_DETAIL],[CONCURRENCY_CONTROL_NUMBER],[APP_CREATE_USERID],[APP_CREATE_TIMESTAMP],[APP_CREATE_USER_GUID],[APP_CREATE_USER_DIRECTORY],[APP_LAST_UPDATE_USERID],[APP_LAST_UPDATE_TIMESTAMP],[APP_LAST_UPDATE_USER_GUID],[APP_LAST_UPDATE_USER_DIRECTORY],[DB_AUDIT_CREATE_USERID],[DB_AUDIT_CREATE_TIMESTAMP],[DB_AUDIT_LAST_UPDATE_USERID],[DB_AUDIT_LAST_UPDATE_TIMESTAMP])
SELECT
    [ROW_ID],[SUBMISSION_OBJECT_ID],[ROW_STATUS_ID],[ROW_NUM],[RECORD_NUMBER],[ROW_VALUE],[ROW_HASH],[IS_RESUBMITTED],[ERROR_DETAIL],[CONCURRENCY_CONTROL_NUMBER],[APP_CREATE_USERID],[APP_CREATE_TIMESTAMP],[APP_CREATE_USER_GUID],[APP_CREATE_USER_DIRECTORY],[APP_LAST_UPDATE_USERID],[APP_LAST_UPDATE_TIMESTAMP],[APP_LAST_UPDATE_USER_GUID],[APP_LAST_UPDATE_USER_DIRECTORY],[DB_AUDIT_CREATE_USERID],[DB_AUDIT_CREATE_TIMESTAMP],[DB_AUDIT_LAST_UPDATE_USERID],[DB_AUDIT_LAST_UPDATE_TIMESTAMP]
...
INSERT INTO [dbo].[HMR_SUBMISSION_ROW_HIST_TMP]
    ([SUBMISSION_ROW_HIST_ID],[EFFECTIVE_DATE_HIST],[END_DATE_HIST],[ROW_ID],[SUBMISSION_OBJECT_ID],[ROW_STATUS_ID],[ROW_NUM],[RECORD_NUMBER],[ROW_VALUE],[ROW_HASH],[IS_RESUBMITTED],[ERROR_DETAIL],[CONCURRENCY_CONTROL_NUMBER],[APP_CREATE_USERID],[APP_CREATE_TIMESTAMP],[APP_CREATE_USER_GUID],[APP_CREATE_USER_DIRECTORY],[APP_LAST_UPDATE_USERID],[APP_LAST_UPDATE_TIMESTAMP],[APP_LAST_UPDATE_USER_GUID],[APP_LAST_UPDATE_USER_DIRECTORY],[DB_AUDIT_CREATE_USERID],[DB_AUDIT_CREATE_TIMESTAMP],[DB_AUDIT_LAST_UPDATE_USERID],[DB_AUDIT_LAST_UPDATE_TIMESTAMP])
SELECT
    [SUBMISSION_ROW_HIST_ID],[EFFECTIVE_DATE_HIST],[END_DATE_HIST],[ROW_ID],[SUBMISSION_OBJECT_ID],[ROW_STATUS_ID],[ROW_NUM],[RECORD_NUMBER],[ROW_VALUE],[ROW_HASH],[IS_RESUBMITTED],[ERROR_DETAIL],[CONCURRENCY_CONTROL_NUMBER],[APP_CREATE_USERID],[APP_CREATE_TIMESTAMP],[APP_CREATE_USER_GUID],[APP_CREATE_USER_DIRECTORY],[APP_LAST_UPDATE_USERID],[APP_LAST_UPDATE_TIMESTAMP],[APP_LAST_UPDATE_USER_GUID],[APP_LAST_UPDATE_USER_DIRECTORY],[DB_AUDIT_CREATE_USERID],[DB_AUDIT_CREATE_TIMESTAMP],[DB_AUDIT_LAST_UPDATE_USERID],[DB_AUDIT_LAST_UPDATE_TIMESTAMP]
...
-- MODIFIED:  Drop rows incapable of data conversion and ensure ROW_ID is populated
PRINT (' ');
PRINT ('Deleting WILDLIFE_REPORT rows with no ROW_NUM: ');

DELETE FROM [dbo].[HMR_WILDLIFE_REPORT] WHERE [ROW_NUM] IS NULL;
GO
...
SELECT
    hwr.[WILDLIFE_RECORD_ID],hwr.[SUBMISSION_OBJECT_ID],hsr.[ROW_ID],hwr.[ROW_NUM],hwr.[VALIDATION_STATUS_ID],hwr.[RECORD_TYPE],hwr.[SERVICE_AREA],hwr.[ACCIDENT_DATE],hwr.[TIME_OF_KILL],hwr.[LATITUDE],hwr.[LONGITUDE],hwr.[HIGHWAY_UNIQUE],hwr.[LANDMARK],hwr.[OFFSET],hwr.[NEAREST_TOWN],hwr.[WILDLIFE_SIGN],hwr.[QUANTITY],hwr.[SPECIES],hwr.[SEX],hwr.[AGE],hwr.[COMMENT],hwr.[GEOMETRY],hwr.[CONCURRENCY_CONTROL_NUMBER],hwr.[APP_CREATE_USERID],hwr.[APP_CREATE_TIMESTAMP],hwr.[APP_CREATE_USER_GUID],hwr.[APP_CREATE_USER_DIRECTORY],hwr.[APP_LAST_UPDATE_USERID],hwr.[APP_LAST_UPDATE_TIMESTAMP],hwr.[APP_LAST_UPDATE_USER_GUID],hwr.[APP_LAST_UPDATE_USER_DIRECTORY],hwr.[DB_AUDIT_CREATE_USERID],hwr.[DB_AUDIT_CREATE_TIMESTAMP],hwr.[DB_AUDIT_LAST_UPDATE_USERID],hwr.[DB_AUDIT_LAST_UPDATE_TIMESTAMP]
FROM [dbo].[HMR_WILDLIFE_REPORT] hwr INNER JOIN [dbo].[HMR_SUBMISSION_ROW] hsr ON hwr.[SUBMISSION_OBJECT_ID] = hsr.[SUBMISSION_OBJECT_ID] AND hwr.[ROW_NUM] = hsr.[ROW_NUM]
GO
...
-- MODIFIED:  Drop rows incapable of data conversion and ensure ROW_ID is populated
PRINT (' ');
PRINT ('Deleting WILDLIFE_REPORT_HIST rows with no ROW_NUM: ');

DELETE FROM [dbo].[HMR_WILDLIFE_REPORT_HIST] WHERE [ROW_NUM] IS NULL;
GO
...
SELECT
    hwr.[WILDLIFE_REPORT_HIST_ID],hwr.[EFFECTIVE_DATE_HIST],hwr.[END_DATE_HIST],hwr.[WILDLIFE_RECORD_ID],hwr.[SUBMISSION_OBJECT_ID],hsr.[ROW_ID],hwr.[ROW_NUM],hwr.[VALIDATION_STATUS_ID],hwr.[RECORD_TYPE],hwr.[SERVICE_AREA],hwr.[ACCIDENT_DATE],hwr.[TIME_OF_KILL],hwr.[LATITUDE],hwr.[LONGITUDE],hwr.[HIGHWAY_UNIQUE],hwr.[LANDMARK],hwr.[OFFSET],hwr.[NEAREST_TOWN],hwr.[WILDLIFE_SIGN],hwr.[QUANTITY],hwr.[SPECIES],hwr.[SEX],hwr.[AGE],hwr.[COMMENT],hwr.[GEOMETRY],hwr.[CONCURRENCY_CONTROL_NUMBER],hwr.[APP_CREATE_USERID],hwr.[APP_CREATE_TIMESTAMP],hwr.[APP_CREATE_USER_GUID],hwr.[APP_CREATE_USER_DIRECTORY],hwr.[APP_LAST_UPDATE_USERID],hwr.[APP_LAST_UPDATE_TIMESTAMP],hwr.[APP_LAST_UPDATE_USER_GUID],hwr.[APP_LAST_UPDATE_USER_DIRECTORY],hwr.[DB_AUDIT_CREATE_USERID],hwr.[DB_AUDIT_CREATE_TIMESTAMP],hwr.[DB_AUDIT_LAST_UPDATE_USERID],hwr.[DB_AUDIT_LAST_UPDATE_TIMESTAMP]
FROM [dbo].[HMR_WILDLIFE_REPORT_HIST] hwr INNER JOIN [dbo].[HMR_SUBMISSION_ROW] hsr ON hwr.[SUBMISSION_OBJECT_ID] = hsr.[SUBMISSION_OBJECT_ID] AND hwr.[ROW_NUM] = hsr.[ROW_NUM]
GO
...
-- MODIFIED:  Drop rows incapable of data conversion and ensure ROW_ID is populated
PRINT (' ');
PRINT ('Deleting WORK_REPORT rows with no ROW_NUM: ');

DELETE FROM [dbo].[HMR_WORK_REPORT] WHERE [ROW_NUM] IS NULL;
GO
...
SELECT
    hwr.[WORK_REPORT_ID],hwr.[SUBMISSION_OBJECT_ID],hsr.[ROW_ID],hwr.[ROW_NUM],hwr.[VALIDATION_STATUS_ID],hwr.[RECORD_TYPE],hwr.[SERVICE_AREA],hwr.[RECORD_NUMBER],hwr.[TASK_NUMBER],hwr.[ACTIVITY_NUMBER],hwr.[START_DATE],hwr.[END_DATE],hwr.[ACCOMPLISHMENT],hwr.[UNIT_OF_MEASURE],hwr.[POSTED_DATE],hwr.[HIGHWAY_UNIQUE],hwr.[LANDMARK],hwr.[START_OFFSET],hwr.[END_OFFSET],hwr.[START_LATITUDE],hwr.[START_LONGITUDE],hwr.[END_LATITUDE],hwr.[END_LONGITUDE],hwr.[STRUCTURE_NUMBER],hwr.[SITE_NUMBER],hwr.[VALUE_OF_WORK],hwr.[COMMENTS],hwr.[GEOMETRY],hwr.[CONCURRENCY_CONTROL_NUMBER],hwr.[APP_CREATE_USERID],hwr.[APP_CREATE_TIMESTAMP],hwr.[APP_CREATE_USER_GUID],hwr.[APP_CREATE_USER_DIRECTORY],hwr.[APP_LAST_UPDATE_USERID],hwr.[APP_LAST_UPDATE_TIMESTAMP],hwr.[APP_LAST_UPDATE_USER_GUID],hwr.[APP_LAST_UPDATE_USER_DIRECTORY],hwr.[DB_AUDIT_CREATE_USERID],hwr.[DB_AUDIT_CREATE_TIMESTAMP],hwr.[DB_AUDIT_LAST_UPDATE_USERID],hwr.[DB_AUDIT_LAST_UPDATE_TIMESTAMP]
FROM [dbo].[HMR_WORK_REPORT] hwr INNER JOIN [dbo].[HMR_SUBMISSION_ROW] hsr ON hwr.[SUBMISSION_OBJECT_ID] = hsr.[SUBMISSION_OBJECT_ID] AND hwr.[ROW_NUM] = hsr.[ROW_NUM]
GO
...
-- MODIFIED:  Drop rows incapable of data conversion and ensure ROW_ID is populated
PRINT (' ');
PRINT ('Deleting WORK_REPORT_HIST rows with no ROW_NUM: ');

DELETE FROM [dbo].[HMR_WORK_REPORT_HIST] WHERE [ROW_NUM] IS NULL;
GO
...
SELECT
    hwr.[WORK_REPORT_HIST_ID],hwr.[EFFECTIVE_DATE_HIST],hwr.[END_DATE_HIST],hwr.[WORK_REPORT_ID],hwr.[SUBMISSION_OBJECT_ID],hsr.[ROW_ID],hwr.[ROW_NUM],hwr.[VALIDATION_STATUS_ID],hwr.[RECORD_TYPE],hwr.[SERVICE_AREA],hwr.[RECORD_NUMBER],hwr.[TASK_NUMBER],hwr.[ACTIVITY_NUMBER],hwr.[START_DATE],hwr.[END_DATE],hwr.[ACCOMPLISHMENT],hwr.[UNIT_OF_MEASURE],hwr.[POSTED_DATE],hwr.[HIGHWAY_UNIQUE],hwr.[LANDMARK],hwr.[START_OFFSET],hwr.[END_OFFSET],hwr.[START_LATITUDE],hwr.[START_LONGITUDE],hwr.[END_LATITUDE],hwr.[END_LONGITUDE],hwr.[STRUCTURE_NUMBER],hwr.[SITE_NUMBER],hwr.[VALUE_OF_WORK],hwr.[COMMENTS],hwr.[GEOMETRY],hwr.[CONCURRENCY_CONTROL_NUMBER],hwr.[APP_CREATE_USERID],hwr.[APP_CREATE_TIMESTAMP],hwr.[APP_CREATE_USER_GUID],hwr.[APP_CREATE_USER_DIRECTORY],hwr.[APP_LAST_UPDATE_USERID],hwr.[APP_LAST_UPDATE_TIMESTAMP],hwr.[APP_LAST_UPDATE_USER_GUID],hwr.[APP_LAST_UPDATE_USER_DIRECTORY],hwr.[DB_AUDIT_CREATE_USERID],hwr.[DB_AUDIT_CREATE_TIMESTAMP],hwr.[DB_AUDIT_LAST_UPDATE_USERID],hwr.[DB_AUDIT_LAST_UPDATE_TIMESTAMP]
FROM [dbo].[HMR_WORK_REPORT_HIST] hwr INNER JOIN [dbo].[HMR_SUBMISSION_ROW] hsr ON hwr.[SUBMISSION_OBJECT_ID] = hsr.[SUBMISSION_OBJECT_ID] AND hwr.[ROW_NUM] = hsr.[ROW_NUM]
GO
...
SET @curr_date = getutcdate();
  ...
  IF EXISTS(SELECT * FROM inserted)
    insert into HMR_SUBMISSION_ROW_HIST ([ROW_ID], [SUBMISSION_OBJECT_ID], [ROW_STATUS_ID], [ROW_NUM], [RECORD_NUMBER], [ROW_VALUE], [ROW_HASH], [START_VARIANCE], [END_VARIANCE], [IS_RESUBMITTED], [ERROR_DETAIL], [CONCURRENCY_CONTROL_NUMBER], [APP_CREATE_USERID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_GUID], [APP_CREATE_USER_DIRECTORY], [APP_LAST_UPDATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USER_DIRECTORY], [DB_AUDIT_CREATE_USERID], [DB_AUDIT_CREATE_TIMESTAMP], [DB_AUDIT_LAST_UPDATE_USERID], [DB_AUDIT_LAST_UPDATE_TIMESTAMP], SUBMISSION_ROW_HIST_ID, END_DATE_HIST, EFFECTIVE_DATE_HIST)
      select [ROW_ID], [SUBMISSION_OBJECT_ID], [ROW_STATUS_ID], [ROW_NUM], [RECORD_NUMBER], [ROW_VALUE], [ROW_HASH], [START_VARIANCE], [END_VARIANCE], [IS_RESUBMITTED], [ERROR_DETAIL], [CONCURRENCY_CONTROL_NUMBER], [APP_CREATE_USERID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_GUID], [APP_CREATE_USER_DIRECTORY], [APP_LAST_UPDATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USER_DIRECTORY], [DB_AUDIT_CREATE_USERID], [DB_AUDIT_CREATE_TIMESTAMP], [DB_AUDIT_LAST_UPDATE_USERID], [DB_AUDIT_LAST_UPDATE_TIMESTAMP], (next value for [dbo].[HMR_SUBMISSION_ROW_H_ID_SEQ]) as [SUBMISSION_ROW_HIST_ID], null as [END_DATE_HIST], @curr_date as [EFFECTIVE_DATE_HIST] from inserted;
...
SET @curr_date = getutcdate();
  ...
  IF EXISTS(SELECT * FROM inserted)
    insert into HMR_WORK_REPORT_HIST ([WORK_REPORT_ID], [SUBMISSION_OBJECT_ID], [ROW_ID], [ROW_NUM], [VALIDATION_STATUS_ID], [RECORD_TYPE], [SERVICE_AREA], [RECORD_NUMBER], [TASK_NUMBER], [ACTIVITY_NUMBER], [START_DATE], [END_DATE], [ACCOMPLISHMENT], [UNIT_OF_MEASURE], [POSTED_DATE], [HIGHWAY_UNIQUE], [LANDMARK], [START_OFFSET], [END_OFFSET], [START_LATITUDE], [START_LONGITUDE], [END_LATITUDE], [END_LONGITUDE], [STRUCTURE_NUMBER], [SITE_NUMBER], [VALUE_OF_WORK], [COMMENTS], [GEOMETRY], [CONCURRENCY_CONTROL_NUMBER], [APP_CREATE_USERID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_GUID], [APP_CREATE_USER_DIRECTORY], [APP_LAST_UPDATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USER_DIRECTORY], [DB_AUDIT_CREATE_USERID], [DB_AUDIT_CREATE_TIMESTAMP], [DB_AUDIT_LAST_UPDATE_USERID], [DB_AUDIT_LAST_UPDATE_TIMESTAMP], WORK_REPORT_HIST_ID, END_DATE_HIST, EFFECTIVE_DATE_HIST)
      select [WORK_REPORT_ID], [SUBMISSION_OBJECT_ID], [ROW_ID], [ROW_NUM], [VALIDATION_STATUS_ID], [RECORD_TYPE], [SERVICE_AREA], [RECORD_NUMBER], [TASK_NUMBER], [ACTIVITY_NUMBER], [START_DATE], [END_DATE], [ACCOMPLISHMENT], [UNIT_OF_MEASURE], [POSTED_DATE], [HIGHWAY_UNIQUE], [LANDMARK], [START_OFFSET], [END_OFFSET], [START_LATITUDE], [START_LONGITUDE], [END_LATITUDE], [END_LONGITUDE], [STRUCTURE_NUMBER], [SITE_NUMBER], [VALUE_OF_WORK], [COMMENTS], [GEOMETRY], [CONCURRENCY_CONTROL_NUMBER], [APP_CREATE_USERID], [APP_CREATE_TIMESTAMP], [APP_CREATE_USER_GUID], [APP_CREATE_USER_DIRECTORY], [APP_LAST_UPDATE_USERID], [APP_LAST_UPDATE_TIMESTAMP], [APP_LAST_UPDATE_USER_GUID], [APP_LAST_UPDATE_USER_DIRECTORY], [DB_AUDIT_CREATE_USERID], [DB_AUDIT_CREATE_TIMESTAMP], [DB_AUDIT_LAST_UPDATE_USERID], [DB_AUDIT_LAST_UPDATE_TIMESTAMP], (next value for [dbo].[HMR_WORK_REPORT_H_ID_SEQ]) as [WORK_REPORT_HIST_ID], null as [END_DATE_HIST], @curr_date as [EFFECTIVE_DATE_HIST] from inserted;
