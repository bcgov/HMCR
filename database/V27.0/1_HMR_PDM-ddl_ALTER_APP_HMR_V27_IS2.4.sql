-- Script generated by Aqua Data Studio Schema Synchronization for MS SQL Server 2016 on Wed Nov 18 16:04:09 PST 2020
...
GO
ALTER TABLE [dbo].[HMR_WORK_REPORT]
	ADD [RECORD_VERSION_NUMBER] int NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
