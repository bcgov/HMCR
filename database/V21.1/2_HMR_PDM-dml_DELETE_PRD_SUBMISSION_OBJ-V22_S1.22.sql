...
-- Updates: 
--	Deleting submission entries in all relevant tables on or before May 06 2020.
-- =============================================
...
(
	...
	WHERE so.SUBMISSION_OBJECT_ID = HMR_WORK_REPORT.SUBMISSION_OBJECT_ID
		...
		AND FORMAT(so.APP_CREATE_TIMESTAMP, 'dd-MM-yyyy') <= '06-MAY-2020'
)
...
DELETE HMR_SUBMISSION_OBJECT
		...
		WHERE
			...
			AND FORMAT(APP_CREATE_TIMESTAMP, 'dd-MM-yyyy') <= '06-MAY-2020'