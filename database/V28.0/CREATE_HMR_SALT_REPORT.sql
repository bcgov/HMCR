...
CREATE TABLE [dbo].[HMR_SALT_REPORT](
	...
	[SNOW_LP_SURF_PCT] [decimal](10, 2) NULL,
	[SNOW_LP_SURF_SITES] [int] NULL,
	[MELTWATER_POND_PCT] [decimal](10, 2) NULL,
	[MELTWATER_POND_SITES] [int] NULL,
	[MELTWATER_SEWER_PCT] [decimal](10, 2) NULL,
	[MELTWATER_SEWER_SITES] [int] NULL,
	[MELTWATER_WTRCRS_PCT] [decimal](10, 2) NULL,
	[MELTWATER_WTRCRS_SITES] [int] NULL,
...
BEGIN TRY
  ...
  insert into HMR_SALT_REPORT ("SALT_REPORT_ID",
      ...
      "MELTWATER_SEWER_PCT",
      "MELTWATER_SEWER_SITES",
      "MELTWATER_WTRCRS_PCT",
      "MELTWATER_WTRCRS_SITES",
      "COMP_INV",
      "SET_VULN_AREAS",
      "ACT_PLAN_PREP",
      "PROT_MEAS_IMPL",
...
BEGIN TRY
  ...
  update HMR_SALT_REPORT
    set "SALT_REPORT_ID" = inserted."SALT_REPORT_ID",
      ...
      "SNOW_LP_SURF_PCT" = inserted."SNOW_LP_SURF_PCT",
      "SNOW_LP_SURF_SITES" = inserted."SNOW_LP_SURF_SITES",
      "MELTWATER_POND_PCT" = inserted."MELTWATER_POND_PCT",
      "MELTWATER_POND_SITES" = inserted."MELTWATER_POND_SITES",
      "MELTWATER_SEWER_PCT" = inserted."MELTWATER_SEWER_PCT",
      "MELTWATER_SEWER_SITES" = inserted."MELTWATER_SEWER_SITES",
      "MELTWATER_WTRCRS_PCT" = inserted."MELTWATER_WTRCRS_PCT",
      "MELTWATER_WTRCRS_SITES" = inserted."MELTWATER_WTRCRS_SITES",
