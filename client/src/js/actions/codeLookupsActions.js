...
export const fetchActivityCodesDropdown = () => (dispatch) => {
  return api.getActivityCodesLite().then((response) => {
    const data = response.data;
    dispatch({
      type: FETCH_ACTIVITY_CODES_DROPDOWN,
      payload: data,
    });
  });
};
