...
const phases = {
  ...
  test:   {namespace:'txkggj-test'  , name: `${name}`, phase: 'test'  , changeId:changeId, suffix: `-test`              , instance: `${name}-test`              , version:`${version}`              , tag:`test-${version}`             , host: `hmr-txkggj-test.pathfinder.gov.bc.ca`            , dotnet_env: 'Production'},
  prod:   {namespace:'txkggj-prod'  , name: `${name}`, phase: 'prod'  , changeId:changeId, suffix: `-prod`              , instance: `${name}-prod`              , version:`${version}`              , tag:`prod-${version}`             , host: `hmr-txkggj-test.pathfinder.gov.bc.ca`            , dotnet_env: 'Production'},
};
