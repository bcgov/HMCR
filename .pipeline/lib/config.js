...
const phases = {
  ...
  test:   {namespace:'txkggj-test'  , name: `${name}`, phase: 'uat'  ,  changeId:changeId, suffix: `-uat`              ,  instance: `${name}-uat`              ,  version:`${version}`              , tag:`uat-${version}`             ,  host: `hmr-txkggj-uat.pathfinder.gov.bc.ca`            ,  dotnet_env: 'UAT'},
