...
const phases = {
  ...
  prod:   {namespace:'txkggj-prod'  , name: `${name}`, phase: 'prod'  , changeId:changeId, suffix: `-prod`              , instance: `${name}-prod`              , version:`${version}`              , tag:`prod-${version}`             , host: `hmcr-txkggj.pathfinder.gov.bc.ca`                 , url_prefix: ''    , bceid_service: ''      ,  export_server: 'prdoas2', dotnet_env: 'Production'},
};
