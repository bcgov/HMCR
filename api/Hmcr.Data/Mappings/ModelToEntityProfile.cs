    ...
    public class ModelToEntityProfile : Profile
    {
        public ModelToEntityProfile()
        {
            ...
            CreateMap<SaltReportDto, HmrSaltReport>()
                ...
                .ForMember(dest => dest.DeicerSodiumFormate, opt => opt.MapFrom(src => src.Sect3.Deicer.SodiumFormate))
                ...
                .ForMember(dest => dest.TreatedAbrasivesSodiumFormate, opt => opt.MapFrom(src => src.Sect3.TreatedAbrasives.SodiumFormate))
                ...
                .ForMember(dest => dest.PrewettingSodiumFormate, opt => opt.MapFrom(src => src.Sect3.Prewetting.SodiumFormate))
                ...
                .ForMember(dest => dest.PretreatmentSodiumFormate, opt => opt.MapFrom(src => src.Sect3.Pretreatment.SodiumFormate))
                ...
                .ForMember(dest => dest.AntiicingSodiumFormate, opt => opt.MapFrom(src => src.Sect3.Antiicing.SodiumFormate))
                ...
                .ForMember(dest => dest.SnowDisposalSiteCapacity, opt => opt.MapFrom(src => src.Sect6.Disposal.DesignCapacity))
                .ForMember(dest => dest.SnowMeltersSnowPercentage, opt => opt.MapFrom(src => src.Sect6.SnowMelter.Percentage))
                .ForMember(dest => dest.SnowLowPermeabilitySurfacePercentage, opt => opt.MapFrom(src => src.Sect6.DesignFeatures.LowPermeabilitySurface.Percentage))
                .ForMember(dest => dest.SnowLowPermeabilitySurfaceSites, opt => opt.MapFrom(src => src.Sect6.DesignFeatures.LowPermeabilitySurface.NumSites))
                .ForMember(dest => dest.MeltwaterRetentionPondPercentage, opt => opt.MapFrom(src => src.Sect6.DesignFeatures.RetentionPond.Percentage))
                .ForMember(dest => dest.MeltwaterRetentionPondSites, opt => opt.MapFrom(src => src.Sect6.DesignFeatures.RetentionPond.NumSites))
                .ForMember(dest => dest.MeltwaterMunicipalSewerPercentage, opt => opt.MapFrom(src => src.Sect6.DesignFeatures.MunicipalSewerSystem.Percentage))
                .ForMember(dest => dest.MeltwaterMunicipalSewerSites, opt => opt.MapFrom(src => src.Sect6.DesignFeatures.MunicipalSewerSystem.NumSites))
                .ForMember(dest => dest.MeltwaterWatercoursePercentage, opt => opt.MapFrom(src => src.Sect6.DesignFeatures.Watercourse.Percentage))
                .ForMember(dest => dest.MeltwaterWatercourseSites, opt => opt.MapFrom(src => src.Sect6.DesignFeatures.Watercourse.NumSites))
                // Section 7
