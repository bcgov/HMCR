...
namespace Hmcr.Model
{
    ...
    public class RegexDefs
    {
        ...
        public RegexDefs()
        {
            ...
            _regexInfos.Add(DollarValue, new RegexInfo { Regex = @"^\-?\d{1,7}(\.\d+)?$", ErrorMessage = "Provided value [{0}] for accomplishment is not a whole number  and/or is incorrectly formatted" });
